# Powerlevel10k 主题配置（由 p10k configure 自动生成）
# Generated by Powerlevel10k configuration wizard on 2024-11-21 at 08:16 CST.
...
() {
  ...
  # 不显示代理的 ip:port 信息
  typeset -g POWERLEVEL9K_PROXY_CONTENT_EXPANSION=''
